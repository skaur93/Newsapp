...
export class Navbar extends Component {
  ...
  <div className="container-fluid">
    <a className="navbar-brand" href="/">NewsSandy</a>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item"><a className="nav-link" href="/about">entertainment</a></li>ment
        ...
        <li className="nav-item"><a className="nav-link" href="/about">tech</a></li>
      </ul>
    </div>
  </div>
</nav>
